...
func (e UserEdges) RequisitionsOrErr() ([]*Requisition, error) {
	if e.loadedTypes[0] {
...
// QueryRequisitions queries the requisitions edge of the User.
func (u *User) QueryRequisitions() *RequisitionQuery {
	return (&UserClient{config: u.config}).QueryRequisitions(u)
}
